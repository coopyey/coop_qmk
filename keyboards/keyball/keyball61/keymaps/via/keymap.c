...
#define HSV_CyberYELLOW     30, 255, 255
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_TENKEY] = LAYOUT(
    PFXU     , PFXP      , _______     , _______  , _______      , _______      ,                                       KC_EQL        , KC_P7    , KC_P8    , KC_P9    , KC_PSLS  , _______  ,
    ...
    _______  , XXXXXXX   , XXXXXXX     , XXXXXXX  , XXXXXXX      , XXXXXXX      , A(KC_F4) ,             QK_KB_10     , KC_P0         , KC_P0    , XXXXXXX  , KC_PDOT  , KC_PENT  , _______  ,
    _______  , _______   , _______     , _______  , _______      , _______      , _______  ,             _______      , _______       ,      /* Trackball */             _______  , _______
  ),
